...
public class TriangleDialog extends JDialog {
    ...
    public TriangleDialog(final ShapeAddListener shapeAddListener) {
        ...
        buttonOK.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                shapeAddListener.onAdd(new Triangle(Double.parseDouble(textField1.getText()), Double.parseDouble(textField2.getText()), Double.parseDouble(textField3.getText())));
                dispose();
            }
        });
