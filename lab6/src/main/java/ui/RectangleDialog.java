...
public class RectangleDialog extends JDialog {
    ...
    public RectangleDialog(final ShapeAddListener shapeAddListener) {
        ...
        buttonOK.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                shapeAddListener.onAdd(new Rectangle(Double.parseDouble(textField1.getText()), Double.parseDouble(textField2.getText())));
                dispose();
            }
        });
